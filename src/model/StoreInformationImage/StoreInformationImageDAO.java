...
public interface StoreInformationImageDAO 
{
	...
	public abstract StoreInformationImageBean update(StoreInformationImageBean sibean,InputStream is,long size);
	public abstract StoreInformationImageBean insert(StoreInformationImageBean sibean,InputStream is,long size);
